...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Create a list view controller and put it in a navigation controller.
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        ...
        // Set delegate of the split view controller to the detail view controller.
        [svc setDelegate:wvc];
        ...
        // On non-iPad devices, go with the older version and add the single nav controller to the window.
        [self.window setRootViewController:masterNav];
    }
